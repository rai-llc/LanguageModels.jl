...
@testset "TransformerREPL.jl" begin
    ...
    TransformerREPL.main(model_file, tokenizer_file, temperature = 0.0f0, steps = 256, prompt = "", io=buf)
    ...
    TransformerREPL.main(model_file, tokenizer_file, temperature = 0.0f0, steps = 256, prompt = "Once upon a time, there was a dog", io=buf)
