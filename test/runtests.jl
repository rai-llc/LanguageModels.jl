...
@testset "LanguageModels.jl" begin
    ...
    LanguageModels.main(temperature = 0.0f0, steps = 256, raw_prompt = "", io=buf)
    ...
    LanguageModels.main(temperature = 0.0f0, steps = 256, raw_prompt = "Once upon a time, there was a dog", io=buf)
    ...
    # Try with mmapping
    LanguageModels.main(temperature = 0.0f0, steps = 256, raw_prompt = "Once upon a time, there was a dog", io=buf; mmap=true)
    @test String(take!(buf)) == output
